...
@Component({
  selector: 'gosi-input-highlight-reschedule-dc',
  templateUrl: './input-highlight-reschedule-dc.component.html',
  styleUrls: ['./input-highlight-reschedule-dc.component.scss']
})
export class InputHighlightRescheduleDcComponent extends InputBaseComponent implements OnInit {
   ...
   * @memberof InputHighlightRescheduleDcComponent
   */
