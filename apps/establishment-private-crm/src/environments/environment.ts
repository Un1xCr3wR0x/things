...
export const environment = {
  ...
  /** firebase: {
    ...
    messagingSenderId: '1:57321616691:web:170e5912660f63e4',
    appId: '1:57321616691:web:170e5912660f63e4'
  }, */
  baseRoutePath: '',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=CRMEstablishment05&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://expapplvd05:8060/crm-private/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  baseUrl: 'http://amnapigeedev.gosi.ins:9920',
  baseDenodoUrl: 'https://denodouat.gosi.ins/server',
  webEstablishmentDenodoApiKey: 'JAAtWXv5FveiwvFogtdrGKhZr2YHD27l',
  webEstablishmentApiKey: 'MRmn17lyG0aGt0yQtKumGKHle8SA0nxU',
  gosiStartDate: {
