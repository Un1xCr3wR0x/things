...
import { TransactionReferenceData, DocumentItem, BilingualText } from '@gosi-ui/core';

/**
 * This is the wrapper component to display comments section
 * @export
 * @class CommentsDcComponent
 */
@Component({
  selector: 'gosi-comments-dc',
  templateUrl: './comments-dc.component.html',
  styleUrls: ['./comments-dc.component.scss']
})
export class CommentsDcComponent implements OnInit, OnChanges {
  // Input Variables
