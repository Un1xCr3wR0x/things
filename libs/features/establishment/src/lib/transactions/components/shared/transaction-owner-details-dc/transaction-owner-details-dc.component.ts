...
@Component({
  selector: 'est-transaction-owner-details-dc',
  templateUrl: './transaction-owner-details-dc.component.html',
  styleUrls: ['./transaction-owner-details-dc.component.scss']
})
export class TransactionOwnerDetailsDcComponent implements OnInit, OnChanges, AfterContentInit {
  /* Input Variables*/
