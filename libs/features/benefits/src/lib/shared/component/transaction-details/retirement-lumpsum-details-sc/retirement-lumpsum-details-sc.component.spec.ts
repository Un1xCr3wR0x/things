...
import { RetirementLumpsumDetailsScComponent } from '../..';
...
describe('RetirementLumpsumDetailsScComponent', () => {
  let component: RetirementLumpsumDetailsScComponent;
  let fixture: ComponentFixture<RetirementLumpsumDetailsScComponent>;
  const sin = 385093829;
  const id = 1003227956;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [RetirementLumpsumDetailsScComponent, BilingualTextPipeMock, NameToStringPipeMock],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RetirementLumpsumDetailsScComponent);
