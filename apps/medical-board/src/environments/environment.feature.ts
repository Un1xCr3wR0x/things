...
export const environment = {
  ...
  loginUrl:
  'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=MedicalBoard16&domain=PublicDomain&scope=PublicRServer.read&redirect=http://feaapplvd16:8060/medical-board/oauth2/callback',
  logoutUrl:
  'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: '4a1yZGly2gtyLiny1IEAlPti1VmoXjMG',
  gosiStartDate: {
