...
import { Contracts, DoctorService, MedicalBoardService, MemberData, MemberService, PersonWrapper, UpdateDoctorResponse } from '@gosi-ui/features/medical-board/lib/shared';
import { ViewDoctorProfileScComponent } from './view-doctor-profile-sc.component';


const routerSpy = { navigate: jasmine.createSpy('navigate') };

describe('ViewDoctorProfileScComponent', () => {
  let component: ViewDoctorProfileScComponent;
  let fixture: ComponentFixture<ViewDoctorProfileScComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ViewDoctorProfileScComponent, BilingualTextPipeMock],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewDoctorProfileScComponent);
