...
export const environment = {
  ...
  baseRoutePath: '',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment19&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://ohsapplvd01:8060/establishment-private/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  baseUrl: 'http://amnapigeedev.gosi.ins:9400',
  ...
  webEstablishmentApiKey: 'eASHtBRRzsxYWq1gbHcGJ4czLb3lLdj8',
  gosiStartDate: {
