...
import { AddMemberFilterRequest, SessionRequest } from '../../models';

@Component({
  selector: 'mb-add-participant-filter-dc',
  templateUrl: './add-participant-filter-dc.component.html',
  styleUrls: ['./add-participant-filter-dc.component.scss']
})
export class AddParticipantFilterDcComponent implements OnInit, OnChanges {
