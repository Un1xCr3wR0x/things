...
import { Contracts, DoctorService, MedicalBoardService, MemberData, MemberService, PersonWrapper, UpdateDoctorResponse, ValidatorMemberBaseScComponent } from '@gosi-ui/features/medical-board/lib/shared';



const routerSpy = { navigate: jasmine.createSpy('navigate') };

describe('ValidatorMemberBaseScComponent', () => {
  let component: ValidatorMemberBaseScComponent;
  let fixture: ComponentFixture<ValidatorMemberBaseScComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ValidatorMemberBaseScComponent, BilingualTextPipeMock],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ValidatorMemberBaseScComponent);
