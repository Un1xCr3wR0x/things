...
import { IndividualAppBarScComponent } from './app-bar-sc.component';
const routerSpy = { navigate: jasmine.createSpy('navigate') };

describe('IndividualAppBarScComponent ', () => {
  let component: IndividualAppBarScComponent;
  let fixture: ComponentFixture<IndividualAppBarScComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [IndividualAppBarScComponent, TimeAgoPipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(IndividualAppBarScComponent);
