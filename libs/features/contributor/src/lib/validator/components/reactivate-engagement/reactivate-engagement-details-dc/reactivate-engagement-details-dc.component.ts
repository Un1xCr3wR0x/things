...
import { EngagementDetails,Contributor, DropDownItems, Establishment, EngagementType, ManageWageConstants, ContributorConstants, ManageWageService, ReactivateEngagementDetails } from '@gosi-ui/features/contributor/lib/shared';

@Component({
  selector: 'cnt-reactivate-engagement-details-dc',
