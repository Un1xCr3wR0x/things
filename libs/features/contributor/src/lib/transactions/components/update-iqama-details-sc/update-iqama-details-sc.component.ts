...
@Component({
  selector: 'update-iqama-details-sc',
  templateUrl: './update-iqama-details-sc.component.html',
  styleUrls: ['./update-iqama-details-sc.component.scss']
})
export class UpdateIqamaDetails extends TransactionBaseScComponent implements OnInit, OnDestroy {
  ...
  fetchDataForView() {
    ...
    super
      .getDocuments(
        DocumentTransactionId.UPDATE_IQAMA_NUMBER,
