...
import { RejoiningDetailsScComponent } from '../..';
...
describe('RejoiningDetailsScComponent', () => {
  let component: RejoiningDetailsScComponent;
  let fixture: ComponentFixture<RejoiningDetailsScComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [RejoiningDetailsScComponent, BilingualTextPipeMock, NameToStringPipeMock],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RejoiningDetailsScComponent);
