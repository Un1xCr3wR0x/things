...
import { CertificateDocumentDcComponent } from './manage-document-sc.component';

const routerSpy = { navigate: jasmine.createSpy('navigate') };

describe('CertificateDocumentDcComponent', () => {
  let component: CertificateDocumentDcComponent;
  let fixture: ComponentFixture<CertificateDocumentDcComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [CertificateDocumentDcComponent],
