...
import { RecalculationGroupedPeriod } from './saned-benefit';
...
export class BenefitRecalculation {
  ...
  changeInEngagementRecalculationDetails?: EngagementChange;
  totalContributionMonths?: number;
}
export class EngagementChange {
  newBenefitDetails?: NewBenefitDetails;
  periods?: Period[];
}
...
export class RecalculationAssessment {
  ...
  plannedAssessmentDate?: GosiCalendar;
  oldDisabilityPercentage?: number;
}
