...
@Component({
  selector: 'cnt-update-wage-dc',
  templateUrl: './update-wage-dc.component.html',
  styleUrls: ['./update-wage-dc.component.scss']
})
export class UpdateWageDcComponent implements OnChanges {
  /* Local variables. */
  isWageChanged = false;
