...
@Component({
  selector: 'gosi-modal-popover-dc',
  templateUrl: './modal-popover-dc.component.html',
  styleUrls: ['./modal-popover-dc.component.scss']
})
export class ModalPopoverDcComponent implements AfterViewInit, OnInit, OnChanges {
