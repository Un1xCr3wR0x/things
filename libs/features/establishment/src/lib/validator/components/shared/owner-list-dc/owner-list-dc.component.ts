...
@Component({
  selector: 'est-owner-list-dc',
  templateUrl: './owner-list-dc.component.html',
  styleUrls: ['./owner-list-dc.component.scss']
})
export class OwnerListDcComponent implements OnInit, OnChanges {
  @Input() owners: Owner[];
