...
export const environment = {
  ...
  // disableAuth: true,
  baseRoutePath: '',
  baseUrl: 'http://amnapigeedev.gosi.ins:9505',
  baseDenodoUrl: 'https://denodouat.gosi.ins/server',
  webEstablishmentDenodoApiKey: 'JAAtWXv5FveiwvFogtdrGKhZr2YHD27l',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PublicEstablishment26&domain=PublicDomain&scope=PublicRServer.read&redirect=http://expapplvd14:8060/establishment-public/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'WafsttUMJAxxG7u52oCRR6b4iUSDGg5Z',
  gosiStartDate: {
