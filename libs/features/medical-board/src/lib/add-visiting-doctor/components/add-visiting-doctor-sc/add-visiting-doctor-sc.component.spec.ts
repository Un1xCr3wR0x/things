...
import { AddVisitingDoctorScComponent } from './add-visiting-doctor-sc.component';


export const activatedRouteStub: ActivatedRouteStub = new ActivatedRouteStub({ identificationNo: 2015767656 });

describe('AddVisitingDoctorScComponent', () => {
  let component: AddVisitingDoctorScComponent;
  let fixture: ComponentFixture<AddVisitingDoctorScComponent>;
  let spy: jasmine.Spy;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [AddVisitingDoctorScComponent],
      providers: [
        {
    ...
    fixture = TestBed.createComponent(AddVisitingDoctorScComponent);
