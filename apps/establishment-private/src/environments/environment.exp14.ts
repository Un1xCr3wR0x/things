...
export const environment = {
    ...
    loginUrl:
      'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment26&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://expapplvd14:8060/establishment-private/oauth2/callback',
    logoutUrl:
      'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
    webEstablishmentApiKey: '73OJVhQfUwDkNPpdVBRZ0O6oiBvJVZ2V',
    gosiStartDate: {
