...
@Component({
  selector: 'est-transaction-establishment-list-dc',
  templateUrl: './transaction-establishment-list-dc.component.html',
  styleUrls: ['./transaction-establishment-list-dc.component.scss']
})
export class TransactionEstablishmentListDcComponent implements OnInit {
  /**
   * Input variables
   */
