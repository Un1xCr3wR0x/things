...
export const environment = {
  ...
  baseRoutePath: '',
  baseUrl: 'http://amnapigeedev.gosi.ins:9750',
  webEstablishmentApiKey: 'x8AcAW1RVMVgtBWFt0FmsBEj82D5b7Hr',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PublicEstablishment14&domain=PublicDomain&scope=PublicRServer.read&redirect=http://feaapplvd15:8060/establishment-public/oauth2/callback',
  logoutUrl:
