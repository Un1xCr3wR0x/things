...
import { RetirementPensionDetailsScComponent } from '../..';
...
describe('RetirementPensionDetailsScComponent', () => {
  let component: RetirementPensionDetailsScComponent;
  let fixture: ComponentFixture<RetirementPensionDetailsScComponent>;
  const sin = 385093829;
  const id = 1003227956;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [RetirementPensionDetailsScComponent, BilingualTextPipeMock, NameToStringPipeMock, HasThisRolePipe],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RetirementPensionDetailsScComponent);
