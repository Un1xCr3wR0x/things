...
export const environment = {
    ...
    baseRoutePath: '',
    baseUrl: 'http://amnapigeedev.gosi.ins:9770',
    ...
    loginUrl:
      'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment16&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://feaapplvd16:8060/establishment-private/oauth2/callback',
    logoutUrl:
      'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
    webEstablishmentApiKey: 'e10ekhQ6agTTht3rLfZ5xGZPAGGMNrvW',
    gosiStartDate: {
