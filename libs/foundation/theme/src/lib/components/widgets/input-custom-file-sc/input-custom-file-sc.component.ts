...
@Component({
  selector: 'gosi-input-custom-file-sc',
  templateUrl: './input-custom-file-sc.component.html',
  styleUrls: ['./input-custom-file-sc.component.scss']
})
export class InputCustomFileScComponent extends FileOperation implements OnInit, OnDestroy, OnChanges {
  ...
  @Input() accessGranted: boolean = false;
  ...
  uploadDocument(file: File) {
    ...
    if(this.accessGranted && this.document.documentClassification === 'Internal'){
    this.document.userAccessList = this.document.userAccessList;
    this.document.allowPublicAccess = true;
    }
    else if(!this.accessGranted && this.document.documentClassification === 'Internal'){
      this.document.userAccessList = [];
      this.document.allowPublicAccess = false;
    }
    else{
      delete this.document.allowPublicAccess;
    }
  ...
  documentExcluded(){
    const checkBoxFlag = this.documentExcludedForm?.get('checkBoxFlag');
    if(checkBoxFlag?.value){
