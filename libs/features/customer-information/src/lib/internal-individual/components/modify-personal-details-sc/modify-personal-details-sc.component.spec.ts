...
import { ModifyPersonalDetailsScComponent } from './modify-personal-details-sc.component';

describe('ChangePersonsScComponent', () => {
  let component: ModifyPersonalDetailsScComponent;
  let fixture: ComponentFixture<ModifyPersonalDetailsScComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ModifyPersonalDetailsScComponent);
