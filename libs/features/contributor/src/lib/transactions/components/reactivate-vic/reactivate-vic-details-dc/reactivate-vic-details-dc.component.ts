...
import { ContributorConstants,EngagementDetails, ReactivateEngagementDetails, ReactivateEngagementRequest } from '@gosi-ui/features/contributor/lib/shared';

@Component({
  selector: 'cnt-reactivate-vic-details-dc',
  templateUrl: './reactivate-vic-details-dc.component.html',
  styleUrls: ['./reactivate-vic-details-dc.component.scss']
})
export class ReactivateVicDetailsDcComponent implements OnInit {
  modalRef: BsModalRef;
