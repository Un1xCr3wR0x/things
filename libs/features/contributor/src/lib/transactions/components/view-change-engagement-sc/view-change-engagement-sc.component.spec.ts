...
import { ViewChangeEngagementScComponent } from '..';

describe('ViewChangeEngagementScComponent', () => {
  let component: ViewChangeEngagementScComponent;
  let fixture: ComponentFixture<ViewChangeEngagementScComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), RouterTestingModule],
      declarations: [ViewChangeEngagementScComponent, ProgressWizardDcMockComponent],
      providers: [
