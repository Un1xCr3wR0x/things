...
export const environment = {
  ...
  baseRoutePath: '',
  baseUrl: 'http://amnapigeedev.gosi.ins:9830',
  baseDenodoUrl: 'https://denodouat.gosi.ins/server',
  webEstablishmentDenodoApiKey: 'JAAtWXv5FveiwvFogtdrGKhZr2YHD27l',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment09&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://expapplvd09:8060/establishment-private/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'EJGGXiRQsAnClGzIFDLz3bioIp6075ui',
  gosiStartDate: {
