...
import { LanguageToken, TransactionReferenceData, WorkFlowActions } from '@gosi-ui/core';

@Component({
  selector: 'gosi-comment-table-content-dc',
  templateUrl: './comment-table-content-dc.component.html',
  styleUrls: ['./comment-table-content-dc.component.scss']
})
export class CommentTableContentDcComponent implements OnInit {
  @Input() comment;
  @Input() limit? = 100;
  @Input() BilligLimit? = 3;
