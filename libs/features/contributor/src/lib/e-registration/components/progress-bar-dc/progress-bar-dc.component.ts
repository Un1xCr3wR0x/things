...
@Component({
  selector: 'cnt-progress-bar-dc',
  templateUrl: './progress-bar-dc.component.html',
  styleUrls: ['./progress-bar-dc.component.scss']
})
export class ProgressBarDcComponent extends BaseComponent implements OnInit {
