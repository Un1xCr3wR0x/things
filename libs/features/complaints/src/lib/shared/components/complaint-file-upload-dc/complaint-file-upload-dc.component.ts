...
import { DocumentItem, ApplicationTypeToken } from '@gosi-ui/core';

@Component({
  selector: 'ces-complaint-file-upload-dc',
  templateUrl: './complaint-file-upload-dc.component.html',
  styleUrls: ['./complaint-file-upload-dc.component.scss']
})
export class ComplaintFileUploadDcComponent implements OnInit, OnChanges {
  /*
   * Input variables
   */
