...
import { ParticipantQueueScComponent } from './participant-queue-sc.component';


export const activatedRouteStub: ActivatedRouteStub = new ActivatedRouteStub({ identificationNo: 2015767656 });

describe('ParticipantQueueScComponent', () => {
  let component: ParticipantQueueScComponent;
  let fixture: ComponentFixture<ParticipantQueueScComponent>;
  let spy: jasmine.Spy;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ParticipantQueueScComponent],
      providers: [
        {
    ...
    fixture = TestBed.createComponent(ParticipantQueueScComponent);
