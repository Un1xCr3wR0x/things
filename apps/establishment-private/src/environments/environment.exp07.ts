...
export const environment = {
   ...
   // disableAuth: true,
    baseRoutePath: '',
    baseUrl: 'http://amnapigeedev.gosi.ins:9620/',
    baseDenodoUrl: 'https://denodouat.gosi.ins/server',
    webEstablishmentDenodoApiKey: 'JAAtWXv5FveiwvFogtdrGKhZr2YHD27l',
    loginUrl:
      'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment07&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://expapplvd07:8060/establishment-private/oauth2/callback',
    logoutUrl:
      'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
    webEstablishmentApiKey: 'pCY4nrFom8IGJsZhmcFotqw7P6rRbR3n',
    gosiStartDate: {
