...
import { OhService, VDFormValue } from '@gosi-ui/features/occupational-hazard/lib/shared';
import { disabiliyDtoList } from '@gosi-ui/features/occupational-hazard/lib/shared/models/disabiliy-dto-list';

@Component({
  selector: 'oh-visiting-doctor-dc',
  templateUrl: './oh-visiting-doctor-dc.component.html',
  styleUrls: ['./oh-visiting-doctor-dc.component.scss']
})
