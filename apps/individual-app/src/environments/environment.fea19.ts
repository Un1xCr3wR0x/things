...
export const environment = {
    ...
    loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=MedicalBoard19&domain=PublicDomain&scope=PublicRServer.read&redirect=http://feaapplvd19:8060/medical-board/oauth2/callback',
    logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
    webEstablishmentApiKey: 'a6iU6RUI80yL3GjahGg8XwxsYyvypcee',
    gosiStartDate: {
