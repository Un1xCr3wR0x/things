...
/*@Directive({
  selector: '[heirbasederived]'
})
export default class HeirBaseComponentDerived extends HeirBaseComponent {}

describe('HeirBaseComponent ', () => {
  let component: HeirBaseComponent;
  let fixture: ComponentFixture<HeirBaseComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [HeirBaseComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HeirBaseComponentDerived);
