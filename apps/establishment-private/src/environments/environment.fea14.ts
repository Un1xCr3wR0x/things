...
export const environment = {
  ...
  baseRoutePath: '',
  baseUrl: 'http://amnapigeedev.gosi.ins:9710',
  disableAuth: true,
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment14&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://feaapplvd14:8060/establishment-private/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'RioJi6CbL8Tu0z3KBVrF8fceWJoHJxfj',
  gosiStartDate: {
