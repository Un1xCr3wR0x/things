...
@Component({
  selector: 'oh-group-injury-person-details-dc',
  templateUrl: './group-injury-person-details-dc.component.html',
  styleUrls: ['./group-injury-person-details-dc.component.scss']
})
export class GroupInjuryPersonDetailsDcComponent extends BaseComponent implements OnInit, OnChanges, AfterViewChecked {
  /**
   * Local Variables
   */
  lang = 'en';
  ...
  @Output() setPayeeType: EventEmitter<number> = new EventEmitter();
  ...
  ngOnInit() {
    ...
    if(this.parentForm){
      this.parentForm.addControl('payeeForm',this.payeeListForm);
    }
    if (
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes && changes.isAddressPresent){
      ...
      if(this.addressForms && !this.isAddressPresent){
        this.parentForm.addControl('addressForms', this.addressForms);
      } else if(this.isAddressPresent){
        this.parentForm.removeControl('addressForms');
      }
    } 
    ...
    if(changes.parentForm && changes.parentForm.currentValue)   {
      ...
      if(this.payeeListForm){
        this.parentForm.addControl('payeeListForm',this.payeeListForm);
      }
      if(this.addressForms && !this.isAddressPresent){
       this.parentForm.addControl('addressForms', this.addressForms);
      }      
  ...
  selectedpayeeList(type) {
    ...
    this.setPayeeType.emit(this.payee);
  }
  /**
   * Save and next
   */
