...
import { ActiveHeirBase } from './active-heir.base';

/** Dummy component to test ValidatorBaseScComponent.
@Directive({
  selector: '[activeheirBase]'
})
export default class ActiveHeirBaseDerived extends ActiveHeirBase {}

describe('ActiveHeirBase', () => {
  let component: ActiveHeirBase;
  let fixture: ComponentFixture<ActiveHeirBase>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActiveHeirBaseDerived);
