...
import { ContributorConstants, ContributorService, Coverage, CoveragePeriodWrapper, EngagementPeriod, ModifyCoverage, ModifyEngagementPeriod } from '@gosi-ui/features/contributor/lib/shared';
...
export class ModifyCoverageDcComponent implements OnInit, OnChanges {
  ...
  coverageChange() {
    // console.log('start date', this.selectedPeriod.startDate);
    // console.log('end date', this.selectedPeriod.endDate);
    this.edit = true;
