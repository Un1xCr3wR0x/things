export class OneTimePaymentBenefitList {
  ...
  beneficiarybenstopdate: number = undefined;
  beneficiarybenstopdatestr: Date = new Date();
  beneficiarybenamount: number = undefined;
  beneficiarybenstatus: string = undefined;
  beneficiarybenstatuscode: number = undefined;
  benefitcomponentlist: string = undefined;
}
