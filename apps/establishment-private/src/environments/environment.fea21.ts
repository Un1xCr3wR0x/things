...
export const environment = {
  ...
  baseRoutePath: '',
  baseUrl: 'http://amnapigeedev.gosi.ins:9405',
  saedniUrlNew:
  ...
  loginUrl:
  'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment22&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://feaapplvd21:8060/establishment-private/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'Ojfo9QtoaH8LZz67nniN6vn3YGQes7ta',
  unifyEngTimeLine: {
    enabled: true,
