...
import { HoldResumeAllowanceScComponent } from './hold-resume-allowance-sc.component';
import { OhClaimsService } from '../../../shared/services/oh-claims.service';

const routerSpy = { navigate: jasmine.createSpy('navigate') };
describe('HoldResumeAllowanceScComponent', () => {
  let component: HoldResumeAllowanceScComponent;
  let fixture: ComponentFixture<HoldResumeAllowanceScComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [HoldResumeAllowanceScComponent],
      providers: [
        OhService,
        DatePipe,
        {
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(HoldResumeAllowanceScComponent);
  ...
  describe('fetchHoldAndAllowanceDetails', () => {
    it('should fetchHoldAndAllowanceDetails', () => {
      ...
      component.holdResumeData.type = 0;
      expect(component.holdResumeData).not.toBe(null);
    });
  });
  describe('fetchHoldAndAllowanceDetails', () => {
    it('fetchHoldAndAllowanceDetails should throw error', () => {
  ...
  describe('fetchHoldAndAllowanceDetails', () => {
    it('should fetchHoldAndAllowanceDetails', () => {
      ...
      component.payeeId = 1;
      component.fetchHoldAndAllowanceDetails();
      component.holdResumeData.type = 2;
      expect(component.holdResumeData).not.toBe(null);
    });
  });
  describe('fetchHoldAndAllowanceDetails', () => {
    it('should fetchHoldAndAllowanceDetails', () => {
      ...
      component.payeeId = 1;
      component.fetchHoldAndAllowanceDetails();
      component.holdResumeData.type = 1;
      expect(component.holdResumeData).not.toBe(null);
    });
  });
  ...
  describe('viewDetails', () => {
    it('should viewDetails', () => {
      ...
      component.holdResumeData.type = 1;
      component.viewDetails();
      expect(component.infoMesssage).not.toBe(null);
    });
  });
});
