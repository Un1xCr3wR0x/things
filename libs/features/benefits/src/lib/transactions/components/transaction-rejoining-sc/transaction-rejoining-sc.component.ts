...
@Component({
  selector: 'bnt-transaction-rejoining-sc',
  templateUrl: './transaction-rejoining-sc.component.html',
  styleUrls: ['./transaction-rejoining-sc.component.scss']
})
export class TransactionRejoiningScComponent implements OnInit {
