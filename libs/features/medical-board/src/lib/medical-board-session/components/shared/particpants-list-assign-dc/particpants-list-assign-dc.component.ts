...
@Component({
  selector: 'mb-particpants-list-assign-dc',
  templateUrl: './particpants-list-assign-dc.component.html',
  styleUrls: ['./particpants-list-assign-dc.component.scss']
})
export class ParticpantsListAssignDcComponent implements OnChanges {
  /**
   * Local variables
   */
  @Input() isAmb: boolean;
  @Input() addparticipantBYMbo: boolean;
 ...
 // @Output() replace: EventEmitter<number> = new EventEmitter();
  ...
  @Input() isAddparticpantbyMb: boolean;
