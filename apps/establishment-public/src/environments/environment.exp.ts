export const environment = {
  ...
  baseRoutePath: '',
  baseUrl: 'http://amnapigeedev.gosi.ins:9810',
  simisDenodoUrl: 'https://denodouat.gosi.ins',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PublicEstablishment08&domain=PublicDomain&scope=PublicRServer.read&redirect=http://expapplvd08:8060/establishment-public/oauth2/callback ',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'qAYMSVTQ5WxLJqkdtiuYdWkQu4aYeAEo',
  gosiStartDate: {
