...
@Component({
  selector: 'blg-installment-guarandee-details-dc',
  templateUrl: './installment-guarandee-details-dc.component.html',
  styleUrls: ['./installment-guarandee-details-dc.component.scss']
})
export class InstallmentGuarandeeDetailsDcComponent implements OnInit, OnChanges {
  //localVariable
  isDownPayment = false;
  gracePeriod: number;
