...
export const environment = {
  ...
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PublicIndividual26&domain=PublicDomain&scope=PublicRServer.read&redirect=http://expapplvd14:8060/individual/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'HK4ZRLGp4zXN73DRIA5BGu9f95advZie',
  gosiStartDate: {
