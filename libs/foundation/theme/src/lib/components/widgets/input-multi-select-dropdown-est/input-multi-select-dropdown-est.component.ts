...
@Component({
  selector: 'gosi-input-multi-select-dropdown-est',
  templateUrl: './input-multi-select-dropdown-est.component.html',
  styleUrls: ['./input-multi-select-dropdown-est.component.scss']
})
export class InputMultiSelectDropdownEstComponent extends InputBaseComponent implements OnInit, OnChanges {
  //variables
  ...
  ngOnInit() {
    ...
    this.language.subscribe(lang => {
      ...
      if (lang === 'en') {
        this.dropdownSettings = {
          ...this.dropdownSettings,
          ...{ textField: 'english', noDataAvailablePlaceholderText: 'Data unavailable',"selectAllText": "Select All","unSelectAllText": "UnSelect All" ,
        ...
        this.dropdownSettings = {
          ...this.dropdownSettings,
          ...{ textField: 'arabic', noDataAvailablePlaceholderText: 'البيانات غير متوفرة',"selectAllText": "تحديد الكل","unSelectAllText": "إلغاء تحديد الكل",
  ...
  multiSelectionToggle(){
    ...
    console.log('multiSelectionIs:',this.multiSelectionMode)
  }
  /**
  ...
  onItemSelectAllArabic(items:any) {
    this.selectedArabicItems = items;
    this.onItemSelect();
  }
  onItemSelectAllEnglish(items:any) {
    this.selectedEnglishItems = items;
    this.onItemSelect();
  }
