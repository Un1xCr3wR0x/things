...
import { ViewAuthorizationScComponent } from '..';

describe('ViewAuthorizationScComponent', () => {
  let component: ViewAuthorizationScComponent;
  let fixture: ComponentFixture<ViewAuthorizationScComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), RouterTestingModule],
      declarations: [ViewAuthorizationScComponent, ProgressWizardDcMockComponent],
      providers: [
