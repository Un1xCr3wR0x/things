...
@Component({
  selector: 'est-validate-mof-payment-details-sc',
  templateUrl: './validate-mof-payment-details-sc.component.html',
  styleUrls: ['./validate-mof-payment-details-sc.component.scss']
})
export class ValidateMofPaymentDetailsScComponent extends ValidatorScBaseComponent implements OnInit {
  mofPaymentDetailsValidatorForm: FormGroup;
  ...
  initialiseView(referenceNumber: number) {
    ...
    this.mofPaymentDetailsValidatorForm = this.createForm();
    this.mofPaymentDetailsValidatorForm.patchValue({
