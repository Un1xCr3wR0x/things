...
@Component({
  selector: 'oh-audit-allowance-reject-dc',
  templateUrl: './audit-allowance-reject-dc.component.html',
  styleUrls: ['./audit-allowance-reject-dc.component.scss']
})
export class AuditAllowanceRejectDcComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  confirmRejectionDetails() {
    ...
    if (this.allowanceRejectForm.valid) {
      ...
      this.rejectModal.comments = this.allowanceRejectForm.get('comments').value;
