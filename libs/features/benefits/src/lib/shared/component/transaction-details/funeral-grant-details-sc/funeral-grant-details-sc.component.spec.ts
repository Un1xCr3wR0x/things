...
import { FuneralGrantDetailsScComponent } from '../..';
...
describe('FuneralGrantDetailsScComponent', () => {
  let component: FuneralGrantDetailsScComponent;
  let fixture: ComponentFixture<FuneralGrantDetailsScComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [FuneralGrantDetailsScComponent, BilingualTextPipeMock, NameToStringPipeMock],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FuneralGrantDetailsScComponent);
