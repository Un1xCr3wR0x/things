...
import { ModifyCommitmentDetailsScComponent } from '../..';
...
describe('ModifyCommitmentDetailsScComponent', () => {
  let component: ModifyCommitmentDetailsScComponent;
  let fixture: ComponentFixture<ModifyCommitmentDetailsScComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ModifyCommitmentDetailsScComponent, BilingualTextPipeMock, NameToStringPipeMock],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ModifyCommitmentDetailsScComponent);
