...
import { Months } from '@gosi-ui/features/collection/billing/lib/shared/enums';
import { BillDetails, DateFormat, UnBillAmount } from '@gosi-ui/features/collection/billing/lib/shared/models';
import moment from 'moment';
import { BsModalRef, BsModalService } from 'ngx-bootstrap/modal';
import { BillSummary } from '@gosi-ui/foundation-dashboard/src/lib/individual-app/models';

@Component({
  selector: 'cim-bill-details-dc',
  templateUrl: './bill-details-dc.component.html',
  styleUrls: ['./bill-details-dc.component.scss']
})
export class BillDetailsDcComponent implements OnInit {
  /* Local variables */
  tempHide = true;
  currentMonth = '';
  previousMonth = '';
  ...
  @Output() navigateToRefund: EventEmitter<null> = new EventEmitter();
  @Input() personId: string;
  @Input() lang: string;
  @Input() isAppProfile: boolean;
  @Input() showRefundVicBtn: boolean;
