...
export const environment = {
  ...
  webEstablishmentApiKey: 'mvtMUqETfJiLqSIdgTsdXLOgEpqBV8Bk',
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=CRMEstablishment19&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://ohsapplvd01:8060/crm-private/oauth2/callback',
  logoutUrl:
