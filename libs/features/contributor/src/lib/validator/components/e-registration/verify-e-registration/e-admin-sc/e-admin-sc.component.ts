...
@Component({
  selector: 'cnt-e-admin-sc',
  templateUrl: './e-admin-sc.component.html',
  styleUrls: ['./e-admin-sc.component.scss']
})
export class EAdminScComponent extends TransactionBaseScComponent implements OnInit {
