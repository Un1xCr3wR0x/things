...
export class ViewAuthorizationScComponent extends TransactionBaseScComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.isAttorney = this.transaction.idParams.get('AUTHORIZATION_TYPE') === 'Attorney';
    this.authorizationId = this.transaction.idParams.get('AUTHORIZATION_ID');
