...
@Component({
  selector: 'oh-document-category-dc',
  templateUrl: './document-category-dc.component.html',
  styleUrls: ['./document-category-dc.component.scss']
})
export class DocumentCategoryDcComponent implements OnChanges, OnInit {
