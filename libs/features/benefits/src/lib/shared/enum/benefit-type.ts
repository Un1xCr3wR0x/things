...
export enum BenefitType {
  ...
  nonOccPensionBenefit = 'Non Occupational Disability Pension Benefit',
  nonOccPensionType = 'Non-Occupational Disability Benefit',
  ...
  oldAgeWomenLumpsum = 'Old Age-Woman Retirement Lumpsum',
  oldAgeWomenPension = 'Old Age-Woman Retirement Pension',
  womanRetirementPension = 'Woman Retirement Pension Benefit Details',
  rpaBenefit = 'Moved to Public Pension Lumpsum (RPA) Benefit',
  nonSaudiRequestLumpsum = 'Request Non Saudi Lumpsum Benefit',
  nonSaudiLumpsum = 'Non-Saudi Lumpsum',
  ...
  occBenefit = 'Occupational Disability Benefit',
  ...
  modifyCommitment = 'Modify Commitment'
}
