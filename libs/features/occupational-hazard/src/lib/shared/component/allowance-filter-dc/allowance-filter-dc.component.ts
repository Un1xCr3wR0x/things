...
@Component({
  selector: 'oh-allowance-filter-dc',
  templateUrl: './allowance-filter-dc.component.html',
  styleUrls: ['./allowance-filter-dc.component.scss']
})
export class AllowanceFilterDcComponent implements OnInit, OnChanges {
  //Local Variables
