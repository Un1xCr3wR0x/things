...
import { VicEngagementPeriod } from '@gosi-ui/features/contributor/lib/shared';

@Component({
  selector: 'cnt-reactivate-vic-wage-table-dc',
...
/** Input variables */
@Input() engagementPeriod: VicEngagementPeriod = new VicEngagementPeriod();
