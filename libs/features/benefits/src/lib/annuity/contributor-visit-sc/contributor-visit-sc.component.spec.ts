...
import { ContributorVisitScComponent } from './contributor-visit-sc.component';

describe('ContributorVisitScComponent', () => {
  let component: ContributorVisitScComponent;
  let fixture: ComponentFixture<ContributorVisitScComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ContributorVisitScComponent],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ContributorVisitScComponent);
