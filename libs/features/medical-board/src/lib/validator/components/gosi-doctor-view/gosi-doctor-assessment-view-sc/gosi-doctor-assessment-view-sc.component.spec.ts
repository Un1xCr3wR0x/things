...
import { GosiDoctorAssessmentViewScComponent } from './gosi-doctor-assessment-view-sc.component';
...
describe('GosiDoctorAssessmentViewScComponent', () => {
  let component: GosiDoctorAssessmentViewScComponent;
  let fixture: ComponentFixture<GosiDoctorAssessmentViewScComponent>;
  let spy: jasmine.Spy;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [GosiDoctorAssessmentViewScComponent],
      providers: [
        {
    ...
    fixture = TestBed.createComponent(GosiDoctorAssessmentViewScComponent);
