...
export const environment = {
  ...
  baseRoutePath: '',
  disableAuth: true,
  baseUrl: 'http://amnapigeedev.gosi.ins:9780',
  baseDenodoUrl: 'https://denodouat.gosi.ins/server',
  webEstablishmentDenodoApiKey: 'JAAtWXv5FveiwvFogtdrGKhZr2YHD27l',
  loginUrl:
  'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PublicIndividual16&domain=PublicDomain&scope=PublicRServer.read&redirect=http://feaapplvd16:8060/individual/oauth2/callback',
  logoutUrl:
  'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'rTjG8BdKtmcVchWB5B0JcKhlRBAnrTMd',
  gosiStartDate: {
