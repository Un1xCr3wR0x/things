...
export const environment = {
    ...
    loginUrl:
      'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PublicEstablishment09&domain=PublicDomain&scope=PublicRServer.read&redirect=http://expapplvd09:8060/establishment-public/oauth2/callback',
    logoutUrl:
      'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
    webEstablishmentApiKey: 'dmFdHaDyTmA2fcQ7PG4Xv8Cv6WFsvlyF',
    gosiStartDate: {
