...
export const environment = {
  ...
  loginUrl:
    'http://idmohslvt01.gosi.ins:7778/oauth2/rest/authorize?response_type=token&client_id=PrivateEstablishment17&domain=PrivateDomain&scope=PrivateRServer.read&redirect=http://10.4.197.101:8060/customer-survey/oauth2/callback',
  logoutUrl:
    'http://idmohslvt01.gosi.ins:7778/oam/server/logout?end_url=http://idmohslvt01.gosi.ins:7778/CustomOAM/CustomLogout.jsp',
  webEstablishmentApiKey: 'LPQAmFMmx4GoySDgf5XdKEdYYwAU0noR'
};
