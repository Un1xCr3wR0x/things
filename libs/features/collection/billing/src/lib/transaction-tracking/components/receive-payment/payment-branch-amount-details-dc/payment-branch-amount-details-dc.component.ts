...
@Component({
  selector: 'blg-payment-branch-amount-details-dc',
  templateUrl: './payment-branch-amount-details-dc.component.html',
  styleUrls: ['./payment-branch-amount-details-dc.component.scss']
})
