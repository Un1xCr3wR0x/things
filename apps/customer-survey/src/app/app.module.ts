...
export function createTranslateLoader(http: HttpClient) {
  ...
  const options: IModuleTranslationOptions = {
    modules: [
      ...
      { moduleName: 'customer-survey', baseTranslateUrl }
    ]
  };
...
@NgModule({
  ...
  providers: [
    ...
    { provide: LanguageToken, useValue: new BehaviorSubject('ar') },
    { provide: ApplicationTypeToken, useValue: ApplicationTypeEnum.CUSTOMER_SURVEY },
    ...
    { provide: MenuToken, useValue: new MenuItem() },
