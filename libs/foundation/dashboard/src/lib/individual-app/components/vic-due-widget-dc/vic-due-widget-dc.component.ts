...
import { DueDateWidgetLabels } from '../../enums';

@Component({
  selector: 'dsb-vic-due-widget-dc',
  templateUrl: './vic-due-widget-dc.component.html',
  styleUrls: ['./vic-due-widget-dc.component.scss']
})
export class VicDueWidgetDcComponent implements OnInit, OnChanges {
  /* Local variables */
  hours = '0';
  lan = 'en';
  daysCount = 0;
