...
@Component({
  selector: 'cim-contributions-chart-dc',
  templateUrl: './contributions-chart-dc.component.html',
  styleUrls: ['./contributions-chart-dc.component.scss']
})
export class ContributionsChartDcComponent implements OnInit, OnChanges {
  ...
  setChart() {
    ...
    if (this.contributionValues?.totalRegularContributionMonths !== 0) {
      ...
      this.contributionBreakupLabel.push(this.lan === 'en' ? 'GOSI Law' : 'نظام التأمينات');
    ...
    if (this.contributionValues?.totalVicContributionMonths !== 0) {
      ...
      if (this.lan === 'en') {
        ...
        this.contributionBreakupLabel.push('الاشتراك الاختياري');
      }
    ...
    if (this.contributionValues?.totalCivilContributionMonths !== 0) {
      ...
      this.contributionBreakupLabel.push(this.lan === 'en' ? 'Public Civil Law' : 'أنظمة التقاعد - مدني');
    ...
    if (this.contributionValues?.totalMilitaryContributionMonths !== 0) {
      ...
      this.contributionBreakupLabel.push(this.lan === 'en' ? 'Public Military Law' : 'أنظمة التقاعد - عسكري');
    ...
    if (this.contributionValues?.totalPpaGccContributionMonths !== 0) {
      ...
      this.contributionBreakupLabel.push(this.lan === 'en' ? 'PPA GCC' : 'أنظمة التقاعد - مد الحماية الخليجي');
    ...
    if (this.contributionValues?.totalLumpSumsPaidMonths !== 0) {
      ...
      this.contributionBreakupLabel.push(this.lan === 'en' ? 'Paid to Contributor' : 'مدد اشتراك مصروفة للمشترك');
              ...
              label: function (tooltipItem, data) {
                ...
                if (label) {
                  ...
                  if (data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index]) {
                    if (data.labels[tooltipItem.index] == 'GOSI Law' || data.labels[tooltipItem.index] == 'نظام التأمينات') {
                    ...
                    if (
                      ...
                      data.labels[tooltipItem.index] == 'الاشتراك الاختياري'
                    ) {
                    ...
                    if (data.labels[tooltipItem.index] == 'Public Civil Law' || data.labels[tooltipItem.index] == 'أنظمة التقاعد - مدني') {
                    ...
                    if (data.labels[tooltipItem.index] == 'Public Military Law' || data.labels[tooltipItem.index] == 'أنظمة التقاعد - عسكري') {
                    ...
                    if (
                      ...
                      data.labels[tooltipItem.index] == 'أنظمة التقاعد - مد الحماية الخليجي'
                    ) {
                    ...
                    if (
                      ...
                      data.labels[tooltipItem.index] == 'مدد اشتراك مصروفة للمشترك'
                    ) {
