...
import { PensionBaseComponent } from './pension.base-component';

/** Dummy component to test ValidatorBaseScComponent. */
/*@Directive({
  selector: '[pensionbasederived]'
})
export default class PensionBaseDerived extends PensionBaseComponent {}

describe('PensionBaseComponent ', () => {
  let component: PensionBaseComponent;
  let fixture: ComponentFixture<PensionBaseComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [PensionBaseComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PensionBaseDerived);
