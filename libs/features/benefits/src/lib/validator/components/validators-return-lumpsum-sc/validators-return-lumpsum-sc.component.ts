...
import { ApplicationTypeEnum, Channel, DocumentItem, RoleIdEnum, formatDate } from '@gosi-ui/core';

@Component({
  selector: 'bnt-validators-return-lumpsum-sc',
  templateUrl: './validators-return-lumpsum-sc.component.html',
  styleUrls: ['./validators-return-lumpsum-sc.component.scss']
})
export class ValidatorsReturnLumpsumScComponent extends ValidatorBaseScComponent implements OnInit, OnDestroy {
  comments: null;
  nin: number;
