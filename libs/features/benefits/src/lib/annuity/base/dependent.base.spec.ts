...
import { of } from 'rxjs';
import { DependentBaseComponent } from './dependent.base-component';
...
/*@Directive({
  selector: '[dependentbasederived]'
})
export default class DependentBaseDerived extends DependentBaseComponent {}

describe('DependentBaseComponent ', () => {
  let component: DependentBaseComponent;
  let fixture: ComponentFixture<DependentBaseComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [DependentBaseComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DependentBaseDerived);
