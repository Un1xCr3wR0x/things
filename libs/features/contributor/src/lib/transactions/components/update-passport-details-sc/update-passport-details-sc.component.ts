...
import { ChangePersonService, ManagePersonConstants } from '@gosi-ui/features/customer-information/lib/shared';
@Component({
  selector: 'cnt-update-passport-details-sc',
  templateUrl: './update-passport-details-sc.component.html',
  styleUrls: ['./update-passport-details-sc.component.scss']
})
export class UpdatePassportDetailsScComponent extends TransactionBaseScComponent implements OnInit, OnDestroy {
